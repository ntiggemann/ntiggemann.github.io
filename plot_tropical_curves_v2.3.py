...
# v2.3.0 - added the option to auto-adjust the range. Added About part. Changed the way how it checks if two points get connected. Updated the interface 
###############################
...
def share_two_or_more_entries(list1, list2):
    """
        Checks if two lists of lists share two or more entries.
...
def plot_trop_polynomial(poly_str,a_x,b_x,a_y,b_y,use_min,
                        ...
                        print_vertices,print_tikz_code_curve,print_tikz_code_dual,tikz_color_curve,tikz_color_DS,tikz_color_NP,auto_adjust,auto_boundary_dist,auto_square,eps):
    try:
        ...
        for i in range(number_of_vertices-1):
            for j in range(i+1,number_of_vertices):
                if share_two_or_more_entries(all_vertices_exp[i],all_vertices_exp[j]):
                    ...
                    a_ind = get_values_indices(a,b,val,eps)[0]
...
def main():
    def on_plot(event=None):
        ...
        plot_trop_polynomial(poly_str,a,b,c,d,use_min,
                                ...
                                color_curve,color_DS,color_NP,make_grid,
                                print_vertices,
                                print_tikz_code_curve,print_tikz_code_dual,tikz_color_curve,tikz_color_DS,tikz_color_NP,auto_adjust,auto_boundary_dist,auto_square,
                                eps)
